...
class LifeStyleController extends Controller
{
    ...
    {
        $masterpreferences = MasterPreference::orderBy('id','DESC')->whereIn('type',['lifestyle'])->where('created_by',null)->get();
        return view('admin.lifestyle.index', compact('masterpreferences'));
    }
    ...
    {
        return view('admin.lifestyle.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = \Validator::make($request->all(), [
          ...
          return redirect('admin/master/lifestyle');
    }
    ...
    public function edit(MasterPreference $masterPreference)
    {
        ...
        return view('admin.lifestyle.edit', compact('masterPreference'));
    }
