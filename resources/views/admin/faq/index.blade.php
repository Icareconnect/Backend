		    ...
		    <div class="col-12">
		      <div class="card">
		        <div class="card-header">
		          <h5 class="card-title">FAQ Listing</h5>
		           <a href="{{ url('admin/faq/create')}}" class="btn btn-sm btn-info float-right">Add New FAQ</a>
		        </div>
		        <!-- /.card-header -->
		        <div class="card-body">
		            ...
		            <tbody>
		             @foreach($faqs as $index => $banner)
			            <tr>
			              ...
			              <td>
			              	<a href="{{ url('admin/faq') .'/'.$banner->id.'/edit'}}" class="btn btn-sm btn-info float-left">Edit</a>
    		...
    		$(".delete-faq").click(function(e){
			          ...
			          Swal.fire({
			            ...
			            if (result.value) {
			                $.ajax({
			                   type:'DELETE',
			                   url:base_url+'/admin/faq/'+banner_id,
			                   data:{id:banner_id},
