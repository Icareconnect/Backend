	@extends('layouts.vertical', ['title' => 'Tip Of The Days'])
		    ...
		    <div class="col-12">
		      <div class="card">
		        <div class="card-header">
		          <h5 class="card-title">Tip Of The Day Listing</h5>
		           <a href="{{ url('admin/tip/create')}}" class="btn btn-sm btn-info float-right">Add New Tip Of The Day</a>
		        </div>
		        <!-- /.card-header -->
		        <div class="card-body">
		            ...
		            <tbody>
		             @foreach($faqs as $index => $banner)
			            <tr>
			              ...
			              <td>
			              	<a href="{{ url('admin/tip') .'/'.$banner->id.'/edit'}}" class="btn btn-sm btn-info float-left">Edit</a>
