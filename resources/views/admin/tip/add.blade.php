@extends('layouts.vertical', ['title' => 'Tip Of The Day'])
@section('content')
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">New Tip Of The Day</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="{{ url('admin/tip')}}" method="post" enctype="multipart/form-data">
