		    ...
		    <div class="col-12">
		      <div class="card">
		        <div class="card-header">
		          <h3 class="card-title">{{ __('text.Custom Master Preference') }} Listing</h3>
		           <a href="{{ url('admin/master/duties/create')}}" class="btn btn-sm btn-info float-right">Add New</a>
		        </div>
		        <!-- /.card-header -->
		        <div class="card-body">
		            ...
		            <tbody>
		             @foreach($masterpreferences as $index => $cluster)
			            <tr>
			              ...
			              <td><a href="{{ url('admin/master/duties') .'/'.$cluster->id.'/edit'}}" class="btn btn-sm btn-info float-left">Edit</a>
    		...
    		$(".delete-cluster").click(function(e){
			          ...
			          Swal.fire({
			            ...
			            if (result.value) {
			                $.ajax({
			                   type:'DELETE',
			                   url:base_url+'/admin/master/duties/'+cluster_id,
			                   data:{id:cluster_id},
