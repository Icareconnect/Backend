...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="{{ url('admin/subscription')}}" method="post" enctype="multipart/form-data">
        ...
        @endif
         <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <textarea class="form-control" rows="3"   name="description"  id="page_body__" placeholder="Place some text here" >{{{old('description') }}}</textarea>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-6">
                  ...
                  <select class="form-control" name="status">
                      <option <?php echo (old('status')=='enable')?"selected":'' ?>  value="enable">Enable</option>
                      <option <?php echo (old('status')=='disable')?"selected":'' ?>  value="disable">Disable</option>
                  </select>
            ...
            <div class="row">
                  <div class="col-sm-8">
                      ...
                      <select class="form-control category_listing" name="permission[]" multiple="multiple">
                          ...
                          <option <?php echo (old('permission')!==null &&  in_array($permission, old('permission')) )?"selected":'' ?>  value="{{ $permission }}">{{ $permission }}</option>
                          @endforeach
                        </select>
