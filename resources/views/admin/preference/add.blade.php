                  ...
                  <div class="col-sm-4">
                      <label>Show on APP</label>
                        <select  class="form-control" name="show_on">
                          <option value="both" <?php echo (old('show_on')=="both")?"selected":'' ?>>Both</option>
                          <option value="user" <?php echo (old('show_on')=="user")?"selected":'' ?>>Patient</option>
                          <option value="sp" <?php echo (old('show_on')=="sp")?"selected":'' ?>>Nurse</option>
                        </select>
