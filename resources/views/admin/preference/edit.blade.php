...
<script type="text/javascript">
  $(document).ready(function() {
      ...
      $(add_button).click(function(e){
          e.preventDefault();
          $(wrapper).append('<div><br><div class="input-group"><input type="text" class="form-control is-warning" name="new_option[name][]" required="" placeholder="Option"><input type="file" class="form-control" name="new_option[image][]">'+mapOptions+'<div><span class="btn btn-danger delete_icon_new">Delete - </span></div></div></div>');
      });
