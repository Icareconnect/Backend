                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{ __('text.Master PreferenceMedicalHistory') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
		    ...
		    <div class="col-12">
		      <div class="card">
		        <div class="card-header">
		          <h3 class="card-title">{{ __('text.Master PreferenceMedicalHistory') }} Listing</h3>
		           <a href="{{ url('admin/master/medical_history/create')}}" class="btn btn-sm btn-info float-right">Add New</a>
		        </div>
		        <!-- /.card-header -->
		        <div class="card-body">
		            ...
		            <tbody>
		             @foreach($masterpreferences as $index => $cluster)
			            <tr>
			              ...
			              <td><a href="{{ url('admin/master/medical_history') .'/'.$cluster->id.'/edit'}}" class="btn btn-sm btn-info float-left">Edit</a>
    		...
    		$(".delete-cluster").click(function(e){
			          ...
			          Swal.fire({
			            ...
			            if (result.value) {
			                $.ajax({
			                   type:'DELETE',
			                   url:base_url+'/admin/master/medical_history/'+cluster_id,
			                   data:{id:cluster_id},
