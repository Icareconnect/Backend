        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3>Edit {{  __('text.Master PreferenceMedicalHistory') }}</h3>
            </div>

            <div class="card-body">
              <form action="{{ route('medical_history.update',[$masterPreference->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
