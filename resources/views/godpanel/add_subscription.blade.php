...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="{{ route('add-subscription')}}" method="post">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <select class="form-control" name="type">
                      ...
                      <option <?php echo (old('type')=='monthly')?"selected":'' ?> value="monthly">Monthly</option>
                      <option <?php echo (old('type')=='weekly')?"selected":'' ?> value="weekly">Weekly</option>
                  </select>
                  @if ($errors->has('type'))
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <select class="form-control" name="global_subscription">
                      <option value="">--Select--</option>
                      <option <?php echo (old('global_subscription')=='yes')?"selected":'' ?> value="yes">Yes</option>
                      <option <?php echo (old('global_subscription')=='no')?"selected":'' ?> value="no">No</option>
                  </select>
