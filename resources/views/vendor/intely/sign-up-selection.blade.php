             ...
             <div class="modal-dialog">
                <div class="modal-content border-0 bg-transparent">
                   <div class="modal-header text-center border-0 p-0">
                      ...
                      <a href="index.html" type="" class="close position-absolute">
                   ...
                   <div class="modal-body border-0 px-sm-5 pb-0 pt-lg-5 mt-lg-5">
                      ...
                      <ul class="sign_up_list three-column d-flex align-items-center justify-content-between">
                        <li>
                          <a href="#">
                            <img src="images/ic_nurse_1.png" alt="">
                            <p>Nurse</p>
                          </a>
                        </li>
                        <li class="active">
                          <a href="#">
                            <img src="images/ic_hospital.png" alt="">
                            <p>Facility</p>
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="images/ic_homecare_1.png" alt="">
                            <p>Homecare</p>
                          </a>
                        </li>
                      </ul>
